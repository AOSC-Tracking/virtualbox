...
schtasks /create /sc ONLOGON /tn Txs /tr C:\Apps\vboxtxs-nat.cmd /rl HIGHEST

netsh advfirewall firewall add rule name="TestExecService" dir=in action=allow ^
program="C:\Apps\vboxtxs-nat.cmd" enable=yes profile=any
pause
